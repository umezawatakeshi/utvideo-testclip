...
my $raws = [
	...
	{ srcn => "yv12",  ofmt => VDVFMT_NV12,  dstn => "nv12",  sizes => $sizes_420_nv12 },
	...
	{ srcn => "yuv42210bitn",  ofmt => VDVFMT_P216, dstn => "yuv10bitn_p216",  sizes => $sizes_422 },
	...
	{ srcn => "yuv42010bitn",  ofmt => VDVFMT_P016, dstn => "yuv10bitn_p016",  sizes => $sizes_420 },
